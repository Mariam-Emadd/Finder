...
import slideOne from './Assests/ExampleCarouselImage/SlideOne (2).jpg'
import slideTwo from "./Assests/ExampleCarouselImage/slideTwo.jpg";
import slideThree from "./Assests/ExampleCarouselImage/SlideThree.jpg";
import slideFour from "./Assests/ExampleCarouselImage/slideFour.jpg";
import './MySlider.css'
function MySlider() {
  return (
